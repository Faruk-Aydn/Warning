package com.hakankuru.yanimda.data.remote.listener

import android.util.Log
import com.hakankuru.yanimda.data.local.dao.EmergencyHistoryDao
import com.hakankuru.yanimda.data.mapper.toIncomingEntity
import com.hakankuru.yanimda.data.mapper.toOutgoingEntity
...
class EmergencyHistorySyncManager @Inject constructor(
    ...
    fun startListening(userId: String) {
        ...
        if (receivedListener == null) {
            receivedListener = firestore.collection("emergencyHistory")
